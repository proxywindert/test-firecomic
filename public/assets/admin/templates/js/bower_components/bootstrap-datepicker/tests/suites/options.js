...
test('Z-dashboard Offset: none', function(){
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .datepicker(),
        dp = input.data('datepicker'),
    ...
    equal(dp.o.zIndexOffset, 10, 'Z-dashboard offset option defaults to 10.');
    equal(picker.css('z-index'), 244, 'Picker Z-dashboard offset is respected.');
});

test('Z-dashboard Offset: with value', function(){
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .datepicker({
                zIndexOffset: 1000
    ...
    equal(dp.o.zIndexOffset, 1000, 'Z-dashboard offset option is accepted.');
    equal(picker.css('z-index'), 1234, 'Picker Z-dashboard offset is respected.');
});
